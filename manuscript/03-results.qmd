...
#| fig-height: 14
#| label: fig-models
#| fig-cap: "A: Coefficient estimates and confidence intervals for the uncorrected model. B: Coefficient estimates and confidence intervals for the corrected model. Only statistically significant interaction terms are shown. Full interaction terms can be found in Supplementary Figures A-3 and A-4."
